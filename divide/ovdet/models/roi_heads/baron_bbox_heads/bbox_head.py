...
class BaronBBoxHead(BBoxHead):
    ...
    def _predict_after_normalize_cls_score(self,
        ...
        if rcnn_test_cfg is None:
            ...
            # print('res_boxes: ', results.bboxes)
            # print('res_scores: ', results.scores)
            # print('res_labels: ', results.labels)
            # results.rpn_rescale_bboxes = bboxes.view(100, 10, 4)
            # results.rpn_rescale_scores = scores.view(100, 10, 4)
